...
extern void measureINT(void);
extern void Timer1IntHandler(void);
extern void ThrustDWNKey(void);
extern void ThrustUpKey(void);
extern void INTDistance(void);
extern void Pirate(void);
...
__root const uVectorEntry __vector_table[] @ ".intvec" =
{
    ...
    INTDistance,                      // GPIO Port C
    Pirate,                      // GPIO Port D
    ThrustUpKey,                      // GPIO Port E
    ...
    IntGPIOa,                      // GPIO Port F
    measureINT,                      // GPIO Port G
